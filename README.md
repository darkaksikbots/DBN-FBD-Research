...
**Статья:** "ФИНАНСОВЫЕ ПУЗЫРИ В РЕТРОСПЕКТИВЕ И НАСТОЯЩЕМ: КОМБИНИРОВАННАЯ ОЦЕНКА РИСКОВ НА ОСНОВЕ ДИНАМИЧЕСКОЙ БАЙЕСОВСКОЙ СЕТИ" (направлена в журнал)
